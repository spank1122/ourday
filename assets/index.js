...
async function refreshUI(){
  ...
  // If gate already passed for this user (sessionStorage) -> go main
  ...
  window.__GATE__ = { sessionUserId: session.user.id, passedKey, gateCode: GATE_CODE };
}
